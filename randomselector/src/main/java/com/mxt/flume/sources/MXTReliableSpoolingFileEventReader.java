...
import com.mxt.flume.sources.MXTSpoolDirectorySourceConfigurationConstants;
...
public class MXTReliableSpoolingFileEventReader implements ReliableEventReader {

    private static final Logger logger = LoggerFactory
            .getLogger(MXTReliableSpoolingFileEventReader.class);
    ...
    private final MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder consumeOrder;
    private final boolean recursiveDirectorySearch;

    private final int waitCount;

    private Optional<MXTReliableSpoolingFileEventReader.FileInfo> currentFile = Optional.absent();
    /** Always contains the last file from which lines have been read. */
    private Optional<MXTReliableSpoolingFileEventReader.FileInfo> lastFileRead = Optional.absent();
    ...
    /**
     * Create a MXTReliableSpoolingFileEventReader to watch the given directory.
     */
    private MXTReliableSpoolingFileEventReader(File spoolDirectory,
                                            ...
                                            DecodeErrorPolicy decodeErrorPolicy,
                                               MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder consumeOrder,
                                            boolean recursiveDirectorySearch,
                                               int waitCount) throws IOException {
        ...
        if (!deletePolicy.equalsIgnoreCase(MXTReliableSpoolingFileEventReader.DeletePolicy.NEVER.name()) &&
                !deletePolicy.equalsIgnoreCase(MXTReliableSpoolingFileEventReader.DeletePolicy.IMMEDIATE.name())) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Initializing {} with directory={}, metaDir={}, " +
                            "deserializer={}",
                    new Object[] {
                            MXTReliableSpoolingFileEventReader.class.getSimpleName(),
...
//            throw new IllegalStateException(message);
        ...
        } else if (deletePolicy.equalsIgnoreCase(MXTReliableSpoolingFileEventReader.DeletePolicy.IMMEDIATE.name())) {
     ...
     * If the {@link #consumeOrder} variable is {@link MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder#OLDEST}
     * then returns the oldest file. If the {@link #consumeOrder} variable
     * is {@link MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder#YOUNGEST} then returns the youngest file.
     * If two or more files are equally old/young, then the file name with
     * lower lexicographical value is returned.
     * If the {@link #consumeOrder} variable is {@link MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder#RANDOM}
     * then cache the directory listing to amortize retreival cost, and return
     * any arbitary file from the directory.
     */
    private Optional<MXTReliableSpoolingFileEventReader.FileInfo> getNextFile() {
        List<File> candidateFiles = Collections.emptyList();

        if (consumeOrder != MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder.RANDOM ||
        ...
        if (consumeOrder == MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder.RANDOM) { // Selected file is random.
            return openFile(selectedFile);
        } else if (consumeOrder == MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder.YOUNGEST) {
...
//                new IllegalStateException(message);
     ...
     *
     * @param file
     * @return {@link MXTReliableSpoolingFileEventReader.FileInfo} for the file to consume or absent option if the
     * file does not exists or readable.
     */
    private Optional<MXTReliableSpoolingFileEventReader.FileInfo> openFile(File file) {
        try {
            ...
            return Optional.of(new MXTReliableSpoolingFileEventReader.FileInfo(file, deserializer));
    ...
    /**
     * Special builder class for MXTReliableSpoolingFileEventReader
     */
    public static class Builder {
        private File spoolDirectory;
        private String completedSuffix =
                MXTSpoolDirectorySourceConfigurationConstants.SPOOLED_FILE_SUFFIX;
        private String includePattern =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_INCLUDE_PAT;
        private String ignorePattern =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_IGNORE_PAT;
        private String trackerDirPath =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_TRACKER_DIR;
        private Boolean annotateFileName =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_FILE_HEADER;
        private String fileNameHeader =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_FILENAME_HEADER_KEY;
        private Boolean annotateBaseName =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_BASENAME_HEADER;
        private String baseNameHeader =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_BASENAME_HEADER_KEY;
        private String deserializerType =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_DESERIALIZER;
        private Context deserializerContext = new Context();
        private String deletePolicy =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_DELETE_POLICY;
        private String inputCharset =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_INPUT_CHARSET;
        private DecodeErrorPolicy decodeErrorPolicy = DecodeErrorPolicy.valueOf(
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_DECODE_ERROR_POLICY
                        .toUpperCase(Locale.ENGLISH));
        private MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder consumeOrder =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_CONSUME_ORDER;
        private boolean recursiveDirectorySearch =
                MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_RECURSIVE_DIRECTORY_SEARCH;

        private int waitCount = MXTSpoolDirectorySourceConfigurationConstants.DEFAULT_WAIT_NUMS;

        public MXTReliableSpoolingFileEventReader.Builder spoolDirectory(File directory) {
            this.spoolDirectory = directory;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder completedSuffix(String completedSuffix) {
            this.completedSuffix = completedSuffix;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder includePattern(String includePattern) {
            this.includePattern = includePattern;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder ignorePattern(String ignorePattern) {
            this.ignorePattern = ignorePattern;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder trackerDirPath(String trackerDirPath) {
            this.trackerDirPath = trackerDirPath;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder annotateFileName(Boolean annotateFileName) {
            this.annotateFileName = annotateFileName;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder fileNameHeader(String fileNameHeader) {
            this.fileNameHeader = fileNameHeader;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder annotateBaseName(Boolean annotateBaseName) {
            this.annotateBaseName = annotateBaseName;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder baseNameHeader(String baseNameHeader) {
            this.baseNameHeader = baseNameHeader;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder deserializerType(String deserializerType) {
            this.deserializerType = deserializerType;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder deserializerContext(Context deserializerContext) {
            this.deserializerContext = deserializerContext;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder deletePolicy(String deletePolicy) {
            this.deletePolicy = deletePolicy;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder inputCharset(String inputCharset) {
            this.inputCharset = inputCharset;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder recursiveDirectorySearch(boolean recursiveDirectorySearch) {
            this.recursiveDirectorySearch = recursiveDirectorySearch;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder decodeErrorPolicy(DecodeErrorPolicy decodeErrorPolicy) {
            this.decodeErrorPolicy = decodeErrorPolicy;
            return this;
        }

        public MXTReliableSpoolingFileEventReader.Builder consumeOrder(MXTSpoolDirectorySourceConfigurationConstants.ConsumeOrder consumeOrder) {
            this.consumeOrder = consumeOrder;
            return this;
        }

        public  MXTReliableSpoolingFileEventReader.Builder waitCount(int waitCount){
            this.waitCount = waitCount;
            return  this;
        }

        public MXTReliableSpoolingFileEventReader build() throws IOException {
            return new MXTReliableSpoolingFileEventReader(spoolDirectory, completedSuffix,
                    ...
                    consumeOrder, recursiveDirectorySearch,waitCount);
        }
    }
